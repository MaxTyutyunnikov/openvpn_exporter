...
docker run -p 9176:9176 \
  ...
  MaxTyutyunnikov/openvpn-exporter -openvpn.status_paths /etc/openvpn_exporter/server.status
```
...
[releases page](https://github.com/MaxTyutyunnikov/openvpn_exporter/releases).
